...
public class MarksFragment extends Fragment {
    private ArrayList<List> listStudents = new java.util.ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MarksAdapter adapter = new MarksAdapter(listStudents, sub, refdb);
        ...
        Button submit = getActivity().findViewById(R.id.save);
